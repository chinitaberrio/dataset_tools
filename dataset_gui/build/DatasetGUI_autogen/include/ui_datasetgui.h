...
#ifndef UI_DATASETGUI_H
#define UI_DATASETGUI_H
...
public:
    ...
    void setupUi(QMainWindow *DatasetGUI)
    {
        ...
        horizontalLayout_3 = new QHBoxLayout(dataset_processing);
        horizontalLayout_3->setObjectName(QStringLiteral("horizontalLayout_3"));
        verticalLayout_8 = new QVBoxLayout();
        verticalLayout_8->setObjectName(QStringLiteral("verticalLayout_8"));
        convertButton = new QPushButton(dataset_processing);
        convertButton->setObjectName(QStringLiteral("convertButton"));
        convertButton->setMinimumSize(QSize(200, 100));

        verticalLayout_8->addWidget(convertButton);
        ...
        textEdit = new QTextEdit(dataset_processing);
    ...
    void retranslateUi(QMainWindow *DatasetGUI)
    {
        ...
        convertButton->setText(QApplication::translate("DatasetGUI", "Convert H264 to MP4", Q_NULLPTR));
